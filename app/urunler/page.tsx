        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-stretch">
          ...
          <div className="bg-white rounded-[3rem] p-4 shadow-[0_20px_60px_-15px_rgba(0,0,0,0.05)] border border-stone-100 group flex flex-col">
            ...
            <div className="h-80 bg-stone-50 rounded-[2.5rem] mb-8 flex flex-col items-center justify-center relative overflow-hidden border-2 border-dashed border-stone-200">
              <div className="absolute top-6 left-6 bg-orange-500 text-white text-xs font-black px-4 py-2 rounded-full tracking-widest uppercase shadow-lg z-10">Çok Satan</div>
              <Package className="text-stone-300 w-20 h-20 mb-4 group-hover:scale-110 transition-transform duration-500" />
              <span className="text-stone-400 font-bold tracking-widest text-sm uppercase">[15 KG Çuval Görseli]</span>
            </div>
            
            <div className="px-6 pb-8 flex-1 flex flex-col">
              <div className="flex justify-between items-start mb-4">
                <h2 className="text-3xl md:text-4xl font-black text-stone-900">15 KG Pelet <br/><span className="text-orange-600 text-2xl">Çuval</span></h2>
              ...
              <div className="space-y-4 mb-10">
                <div className="flex items-center gap-3"><div className="w-6 h-6 rounded-full bg-emerald-100 text-emerald-600 flex items-center justify-center"><Check size={14} /></div><span className="font-bold text-stone-700">Çap: 6 mm / 8 mm</span></div>
                <div className="flex items-center gap-3"><div className="w-6 h-6 rounded-full bg-emerald-100 text-emerald-600 flex items-center justify-center"><Check size={14} /></div><span className="font-bold text-stone-700">Kül Oranı: &lt; %1</span></div>
          ...
          <div className="bg-white rounded-[3rem] p-4 shadow-[0_20px_60px_-15px_rgba(0,0,0,0.05)] border border-stone-100 group flex flex-col">
            ...
            <div className="h-80 bg-stone-900 rounded-[2.5rem] mb-8 flex flex-col items-center justify-center relative overflow-hidden border-2 border-dashed border-stone-700">
               <div className="absolute top-6 left-6 bg-stone-700 text-white text-xs font-black px-4 py-2 rounded-full tracking-widest uppercase shadow-lg border border-stone-600 z-10">Avantajlı</div>
               <Package className="text-stone-700 w-20 h-20 mb-4 group-hover:scale-110 transition-transform duration-500" />
               <span className="text-stone-500 font-bold tracking-widest text-sm uppercase">[25 KG Çuval Görseli]</span>
            </div>
            
            <div className="px-6 pb-8 flex-1 flex flex-col">
              <div className="flex justify-between items-start mb-4">
                <h2 className="text-3xl md:text-4xl font-black text-stone-900">25 KG Pelet <br/><span className="text-stone-500 text-2xl">Çuval</span></h2>
                <Package className="text-stone-300 hidden sm:block" size={40} />
              </div>
              <p className="text-stone-500 font-medium leading-relaxed mb-8 flex-1">
